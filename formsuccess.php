 ...
 <div class="modal " id="result" >
      <div class="modal-dialog ">
        <div class="modal-content" style="background: url(images/background.jpg); color: white;">
          ...
          <div class="modal-body  "> Thank You for submitting the request<br> Our Experts will get in touch with you in 24 hours. 
          </div>
        </div>
      </div>
    </div>
...
<!-- <script type="text/javascript">
  function hoverindicator(n) {
  // This function removes the "active" class of all steps...
  var i, x = document.getElementsByClassName("hovertest");
  for (i = 0; i < x.length; i++) {
    x[i].className = x[i].className.replace("focused", "nonfocused");
  }
  //... and adds the "active" class on the current step:
...
function nonhover(n) {
  ...
  for (i = 0; i < x.length; i++) {
    if(n!=(i+1)){
      x[i].className = x[i].className.replace("nonfocused", "focused");
    }
 ...
 /* x[n].className += "focused";*/
     ...
     <div class="container "  >
        ...
        <div class="col-sm-4 tile " data-aos="zoom-in">
          <div id= "1" class="focused hovertest " onmouseover="hoverindicator(1)" onmouseout="nonhover(1)">
        ...
        <div class="col-sm-4 tile "data-aos="zoom-in" >
          <div id= "2" class="focused hovertest "onmouseover="hoverindicator(2)"  onmouseout="nonhover(2)">
